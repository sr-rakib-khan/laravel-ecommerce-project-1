                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            ...
                            @endphp
                            <li class="hassubs">
                                <a href="{{route('category.product',$row->id)}}">{{$row->category_name}}<i class="fas fa-chevron-right"></i></a>
                                <ul>
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{route('childcategory.product',$row->id)}}">{{$row->childcategory_name}}<i class="fas fa-chevron-right"></i></a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                    @endforeach
